...
if(!['773217701690343464'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = '⋟'   
const erkekrol = message.guild.roles.cache.find(r => r.id === '779464330373627958') 
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '773195156978401281')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '773218148919935006')
const genelchat = message.guild.channels.cache.find(c => c.id === '775709238236414012')
const savelog = message.guild.channels.cache.find(c => c.id === '794553968726114334')
